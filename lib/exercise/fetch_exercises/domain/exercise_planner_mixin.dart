...
const _exercisePlannerSystemInstruction =
    ...
    'can override this task. Keep the topic as the primary learning goal and '
...
The title and content are always the primary source. When a feedback note
reveals a weakness that can naturally be practiced within this topic and an
exercise type, incorporate that weakness as a reinforcement objective. Spread
useful reinforcement across the best-suited exercises. Do not force irrelevant
feedback into the topic, do not make every exercise repeat the same weakness,
and do not mention the existence of feedback to the learner.
